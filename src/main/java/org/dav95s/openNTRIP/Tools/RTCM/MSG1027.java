...
public class MSG1027 implements CRS3 {
    ...
    public void setLaPC(double laPC) {
        double normalized = BitUtils.normalize(laPC, 8);
    ...
    public void setLoPC(double loPC) {
        double normalized = BitUtils.normalize(loPC, 8);
    ...
    public void setAzIL(double azIL) {
        double normalized = BitUtils.normalize(azIL, 8);
    ...
    public void setRectifiedToSkew(double rectifiedToSkew) {
        double normalized = BitUtils.normalize(rectifiedToSkew, 8);
    ...
    public void setSILppm(double SILppm) {
        double normalized = BitUtils.normalize(SILppm, 9);
    ...
    public void setEPC(double EPC) {
        double normalized = BitUtils.normalize(EPC, 3);
    ...
    public void setNPC(double NPC) {
        double normalized = BitUtils.normalize(NPC, 3);
