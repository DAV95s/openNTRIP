...
class CRS {
    ...
    private void factory1021(TransformationType transformationType) {
        ...
        msg1021.setB_valid(areaOfValidity.getDouble("LatCenter"));
        msg1021.setL_valid(areaOfValidity.getDouble("LonCenter"));
        msg1021.setdB_valid(areaOfValidity.getDouble("Height"));
        msg1021.setdL_valid(areaOfValidity.getDouble("Width"));
        JSONObject datum = target.getJSONObject("Datum");
        msg1021.setdX(datum.getBigDecimal("dX"));
        msg1021.setdY(datum.getBigDecimal("dY"));
        msg1021.setdZ(datum.getBigDecimal("dZ"));
        msg1021.setRx(datum.getBigDecimal("rX"));
        msg1021.setRy(datum.getBigDecimal("rY"));
        msg1021.setRz(datum.getBigDecimal("rZ"));
        msg1021.setdS(datum.getBigDecimal("dS"));
        JSONObject sourceEllipsoid = source.getJSONObject("Ellipsoid");
        msg1021.setAs(sourceEllipsoid.getBigDecimal("a"));
        msg1021.setBs(sourceEllipsoid.getBigDecimal("b"));
        JSONObject targetEllipsoid = target.getJSONObject("Ellipsoid");
        msg1021.setAt(targetEllipsoid.getBigDecimal("a"));
        msg1021.setBt(targetEllipsoid.getBigDecimal("b"));
