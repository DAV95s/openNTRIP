...
public class MSG1025 implements CRS3 {
    ...
    public void setLaNO(double laNO) {
        double normalized = Normalize.normalize(laNO, 8);
    ...
    public void setLoNO(double loNO) {
        double normalized = Normalize.normalize(loNO, 8);
    ...
    public void setS(double s) {
        double normalized = Normalize.normalize(s, 6);
    ...
    public void setFalseEasting(double falseEasting) {
        double normalized = Normalize.normalize(falseEasting, 4);
    ...
    public void setFalseNorthing(double falseNorthing) {
        double normalized = Normalize.normalize(falseNorthing, 4);
