...
import org.dav95s.openNTRIP.protocols.rtcm.assets.CRS1;
...
public class MSG1021 implements CRS1 {
    ...
    public void setLatValid(double latValid) {
        double normalized = Normalize.normalize(latValid, 6);
    ...
    public void setLonValid(double lonValid) {
        double normalized = Normalize.normalize(lonValid, 6);
    ...
    public void setdLatValid(double dLatValid) {
        double normalized = Normalize.normalize(dLatValid, 6);
    ...
    public void setdLonValid(double dLonValid) {
        double normalized = Normalize.normalize(dLonValid, 6);
        checkArgument(0 <= normalized && normalized <= 9.10166);
    ...
    public void setdX(double dX) {
        double normalized = Normalize.normalize(dX, 4);
    ...
    public void setdY(double dY) {
        double normalized = Normalize.normalize(dY, 4);
        checkArgument(-4194.303 <= normalized && normalized <= 4194.303);
        this.dY = normalized;
    }
    ...
    public void setdZ(double dZ) {
        double normalized = Normalize.normalize(dZ, 4);
        checkArgument(-4194.303 <= normalized && normalized <= 4194.303);
        this.dZ = normalized;
    }
    ...
    public void setRx(double rx) {
        double normalized = Normalize.normalize(rx, 6);
    ...
    public void setRy(double ry) {
        double normalized = Normalize.normalize(ry, 6);
        checkArgument(-42949.67294 <= normalized && normalized <= 42949.67294);
        Ry = normalized;
    }
    ...
    public void setRz(double rz) {
        double normalized = Normalize.normalize(rz, 6);
        checkArgument(-42949.67294 <= normalized && normalized <= 42949.67294);
        Rz = normalized;
    }
    ...
    public void setdS(double dS) {
        double normalized = Normalize.normalize(dS, 5);
    ...
    public void setAs(double as) {
        double normalized = Normalize.normalize(as, 4);
    ...
    public void setBs(double bs) {
        double normalized = Normalize.normalize(bs, 4);
    ...
    public void setAt(double at) {
        double normalized = Normalize.normalize(at, 4);
        checkArgument(6370000 <= normalized && normalized <= 6386777.215);
        this.At = normalized;
    }
    ...
    public void setBt(double bt) {
        double normalized = Normalize.normalize(bt, 4);
        checkArgument(6350000 <= normalized && normalized <= 6383554.431);
        this.Bt = normalized;
    }
